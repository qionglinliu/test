...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/our.yaml', help='data.yaml path')
    ...
    parser.add_argument('--project', default='runs/tardal_png_640_512s', help='save to project/name')
